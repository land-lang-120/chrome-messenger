...
import {
  ...
  IconChat, IconChatFilled,
  IconGames, IconGamesFilled,
  IconTasks, IconTasksFilled,
...
function AppShell() {
  ...
  const navItems: readonly BottomNavItem[] = [
    ...
    { id: 'tasks',  label: t('navTasks'),  icon: <IconTasks />, iconActive: <IconTasksFilled /> },
    { id: 'games',  label: t('navGames'),  icon: <IconGames />, iconActive: <IconGamesFilled /> },
    { id: 'notifs', label: t('navNotifs'), icon: <IconBell />,  iconActive: <IconBellFilled />, badge: unreadNotifsCount() > 0 },
  ];
